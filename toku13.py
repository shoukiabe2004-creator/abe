...
def main():
    ...
    st.caption("Rate styles & colors. Only outfits with total weight ≥ 12 will be recommended.")
        ...
        for col, img in zip(cols, st.session_state["images"]):
            with col:
                ...
                with st.expander("Why this image was recommended", expanded=True):
                    ...
                    - Meets minimum weight requirement (**≥12**)
